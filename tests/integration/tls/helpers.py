...
async def check_security_index_initialised(juju: jubilant.Juju, unit_ip: str) -> bool:
...
async def check_unit_tls_configured(juju: jubilant.Juju, unit_ip: str, unit_name: str) -> bool:
    ...
    """
    response = await http_request(juju, "GET", f"https://{unit_ip}:9200")
...
async def get_loaded_tls_certificates(juju: jubilant.Juju, unit_ip: str) -> Dict:
