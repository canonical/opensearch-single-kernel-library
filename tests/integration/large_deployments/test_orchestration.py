...
from opensearch_single_kernel.core.base_models import PeerClusterOrchestrators
...
# After the failover app is scaled to 0 and back to 1, it comes back as a failover and not main
...
async def test_scale_promoted_main_to_0_then_up(ops_test: OpsTest) -> None:
    ...
    await wait_until(
        ...
        apps_statuses={
            ...
            DATA_APP: [FAILOVER_NOT_READY_STATUS],
            DATA_APP_TWO: [FAILOVER_NOT_READY_STATUS],
        },
    )
