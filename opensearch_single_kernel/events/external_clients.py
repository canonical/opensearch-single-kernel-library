...
class ExternalClientsEventsHandler(Object):
    ...
    def _on_index_requested(self, event: IndexRequestedEvent) -> None:  # noqa
        ...
        self.charm.external_clients_manager.update_relation_version(external_client)
        self.charm.external_clients_manager.update_relation_credentials(
            external_client, username, pwd
        )
        self.charm.external_clients_manager.update_relation_index(external_client, event.index)
        ...
        self.charm.external_clients_manager.update_relation_endpoints(external_client, nodes)
